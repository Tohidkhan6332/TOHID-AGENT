...
function createApi(meta){
  return {
    ...
    send:meta.send,
    db,
    log:(...a)=>console.log("[plugin:"+meta.name+"]",...a)
  };
}
...
module.exports={ROOT,REGISTRY,isOwner,validateSource,installSource,installFromUrl,installFile,load,enable,disable,remove,list,getCommand,dispatchCommand,dispatchMessage,boot};
