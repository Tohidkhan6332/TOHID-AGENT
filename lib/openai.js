...
async function askGemini(userId,text,options={}) {const {isOwner=false,imageData=null,baileysExtras=null,sock=null,jid=null,language="English"}=options;
