...
const COMMANDS = [
  // Downloader / media
  ["play","media","Download/play audio from a search query",["song","music"],[]],
  ["song","media","Download a song",["play"],[]],
  ["video","media","Download or generate video",["vid","ytvideo"],[]],
  ["ytmp3","downloader","YouTube to MP3",["ytaudio"],[]],
  ["ytmp4","downloader","YouTube to MP4",["ytvideo"],[]],
  ["facebook","downloader","Download Facebook media",["fb","fbdl"],[]],
  ["instagram","downloader","Download Instagram media",["ig","igdl"],[]],
  ["tiktok","downloader","Download TikTok media",["tt","ttdl"],[]],
  ["twitter","downloader","Download X/Twitter media",["xdl","twitterdl"],[]],
  ["pinterest","downloader","Download Pinterest media",["pin","pindl"],[]],
  ["spotify","downloader","Resolve Spotify media",["sp","spdl"],[]],
  ["mediafire","downloader","Download MediaFire files",["mfire"],[]],
  ["apk","downloader","Find/download APK information",["app"],[]],
