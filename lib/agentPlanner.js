...
const PROTECTED=new Set([
  ...
  "heroku_restart_app","heroku_stop_app","heroku_start_app","heroku_scale_app","heroku_redeploy"
]);
...
const READ_ONLY=new Set([
  ...
  "github_search_commits","github_read_file","heroku_list_apps","heroku_app_info"
]);
