...
function validate(){
  ...
  if(process.env.NODE_ENV==="production"&&!cfg.mongoUri) errors.push("MONGO_URI is required in production for persistent WhatsApp auth and memory.");
