...
function validate(){
  ...
  if(cfg.sessionId){if(cfg.pairingNumber)warnings.push("SESSION_ID is configured; PAIRING_NUMBER will be ignored.");}else if(cfg.loginMethod==="pairing"&&!cfg.pairingNumber) warnings.push("PAIRING_NUMBER is empty; the bot will use the normal QR login.");
