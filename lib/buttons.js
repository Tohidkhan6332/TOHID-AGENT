...
function actionToText(id){
  const map={
    ...
    tohid_settings:"__TOHID_SETTINGS__",tohid_contact:"__TOHID_CONTACT__",tohid_web:"__TOHID_WEB__",tohid_list:"__TOHID_LIST__",tohid_dev:"__TOHID_DEV__",tohid_plan:"__TOHID_PLAN__",
...
module.exports={relayInteractive,sendContactMenu,sendWebMenu,sendLanguageMenu,sendHelp,sendHelpByMode,sendLanguageMenuByMode,getInteractiveId,actionToText,sendActionConfirmation,sendCommandMenu,sendMain,sendList,sendDev,sendSettings,sendTextMenu,sendMenuByMode};
