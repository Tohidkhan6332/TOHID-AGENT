const FOOTER="TOHID-AGENT V5 • By Tohid";
...
const MENUS={
  main:[
    ...
    ["menu_stats","📊 Stats"],["menu_admin","🛡️ Admin"],["menu_settings","⚙️ Settings"]
  ],
  settings:[
    ["settings_voice_on","🎙️ Voice ON"],["settings_voice_off","🔇 Voice OFF"],
    ["settings_memory_on","🧠 Memory ON"],["settings_memory_off","🧹 Memory OFF"],
    ["settings_buttons","🔘 Use Buttons"],["settings_text","📝 Use Text"],["settings_status","📱 UI Status"],["menu_back","⬅️ Back"]
  ],
  github:[
...
async function sendMenu(sock,jid,kind="main",options={}){
  ...
  const text=options.text||"🤖 *TOHID-AGENT V5*\\nSelect an option:";
