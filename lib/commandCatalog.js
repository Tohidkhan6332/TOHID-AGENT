...
function commandRows(){return SECTIONS.map(s=>({title:s.title,rows:s.items.map(([cmd,desc])=>({title:cmd.slice(0,24),description:desc.slice(0,68),id:idFor(cmd)}))}));}
...
module.exports={SECTIONS,text,menuText,commandRows,commandMap,idFor};
