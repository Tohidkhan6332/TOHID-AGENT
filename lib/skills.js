const skills=[
  ...
  {id:"mission",name:"Mission Control",status:"active",description:"Persistent mission lifecycle, progress tracking, cancellation and verification."},
  {id:"scheduler",name:"Task Scheduler",status:"active",description:"MongoDB-backed scheduled jobs with bounded recurring execution."}
];
